...
def optimize_model(i_episode):
    ...
    writer.add_scalar("losses/td_loss", loss.item(), i_episode)
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        observation, reward, terminated, truncated, infos = env.step(action.item())
        ...
        if done:
            if infos and "episode" in infos:
                writer.add_scalar("charts/episodic_return", infos["episode"]["r"], i_episode)
            break
