...
| mk (b : Bread) (f : Sum Cheese Spread)

structure Sandwich1 : Type :=
(b : Bread) (f : Sum Cheese Spread)
...
def jam_sandwich1 : Sandwich1 := Sandwich1.mk Bread.wheat (Sum.inr Spread.jam)
